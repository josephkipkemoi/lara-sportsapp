    ...
    return (
        <div className="container">       
            <div className="p-3 form-group">
                ...
                <label htmlFor="exampleInputPassword1" className="d-block mt-2">Confirm Password</label>
                <input type="password" className="form-control" id="exampleInputPassword1" aria-describedby="PasswordHelp"/>
                <small id="PasswordHelp" className="form-text text-muted">Confirm your password</small>
        
                <button className="btn btn-warning fw-bold w-100 mt-2">Register</button>
